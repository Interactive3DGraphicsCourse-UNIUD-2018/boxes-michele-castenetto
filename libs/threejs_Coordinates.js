...
var Coordinates = {
	...
	drawGrid:function(scene, params) {
        params = params || {};
	...
	drawGround:function(scene, params) {
        params = params || {};
		var size = params.size !== undefined ? params.size:100;
	...
	drawAxes:function(scene, params) {
	...
	drawAllAxes:function(scene, params) {
        params = params || {};
		var axisRadius = params.axisRadius !== undefined ? params.axisRadius:0.04;
		var axisLength = params.axisLength !== undefined ? params.axisLength:11;
		var axisTess = params.axisTess !== undefined ? params.axisTess:48;
		...
		var axisYMaterial = new THREE.MeshBasicMaterial({ color: 0x00FF00 });
